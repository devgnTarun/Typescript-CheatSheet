"use strict";
// Datatypes Ts
// let name = 'Tarun'; Name is shown already declared because its inside the window object , which you can check in javascript
// let naam:string = 'Tarun'; Easy formula
// let naam = <string> 'Tarun'; Another syntax to get it now , what is that
// let naam:any = 'Tarun'; 
// naam = 9; ----------------> In this case Typescript knows its any, so, it can be changed from string to number type
// let naam:string = "Tarun";
